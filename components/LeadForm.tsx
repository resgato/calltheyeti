  ...
  return (
    <div className="w-full max-w-xl rounded-lg border border-black/10 dark:border-white/10 bg-white dark:bg-gray-50 p-6 shadow-sm">
      ...
      <form onSubmit={handleSubmit} className="mt-4 grid grid-cols-1 gap-3">
        ...
        <div className="grid gap-1">
          <label htmlFor="phone" className="text-sm font-medium text-black dark:text-black">Phone</label>
          <input 
            id="phone" 
            name="phone" 
            required 
        ...
        <div className="grid gap-1">
          <label htmlFor="email" className="text-sm font-medium text-black dark:text-black">Email (optional)</label>
          <input 
            id="email" 
            name="email" 
            type="email" 
        ...
        <div className="grid gap-1">
          <label htmlFor="service" className="text-sm font-medium text-black dark:text-black">Service needed</label>
          <select 
            id="service" 
            name="service" 
        ...
        <div className="grid gap-1">
          <label htmlFor="zip" className="text-sm font-medium text-black dark:text-black">ZIP code</label>
          <input 
            id="zip" 
            name="zip" 
            placeholder="85001" 
        ...
        <div className="grid gap-1">
          <label htmlFor="message" className="text-sm font-medium text-black dark:text-black">Brief description</label>
          <textarea 
            id="message" 
            name="message" 
            rows={3} 
