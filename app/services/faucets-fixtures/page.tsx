      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="prose prose-lg max-w-none">
            <h2>Faucet Installation & Replacement</h2>
            <p>
            ...
            <h3>Sink Installation & Repair</h3>
            <p>
            ...
            <h3>Toilet Installation & Repair</h3>
            <p>
            ...
            <h2>Common Questions About Faucets & Fixtures</h2>
            
            <h3>How much does faucet installation cost?</h3>
            <p>
            ...
            <h3>Do I need to replace my faucet or can it be repaired?</h3>
            <p>
            ...
            <h3>How much does toilet installation cost?</h3>
            <p>
            ...
            <h3>Can you install a garbage disposal?</h3>
            <p>
            ...
            <h3>Do you offer emergency fixture repair?</h3>
            <p>
        ...
        <div className="space-y-6">
          <div className="bg-gray-50 p-6 rounded-lg">
            <h3 className="text-lg font-semibold mb-4">Get a Faucet/Fixture Quote</h3>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <p className="text-sm text-black/70 mb-4">
              Fixture emergency? We provide 24/7 emergency repair service.
            </p>
            <a 
