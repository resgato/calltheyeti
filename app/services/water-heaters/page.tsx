    ...
    <main className="mx-auto max-w-6xl px-4 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="mb-8">
            <img src="/arizonawaterheater.png" alt="Water heater installation" className="w-full h-64 object-cover rounded-2xl shadow-md" />
          </div>

          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Water Heater Installation & Replacement</h2>
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Types of Water Heaters We Install</h3>
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Water Heater Installation Process</h3>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Water Heater Repair Services</h2>
              <p className="text-black dark:text-black mb-6">
                We provide comprehensive repair services to keep your water heater working efficiently 
                and safely.
              </p>

              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Common Water Heater Problems</h3>
              <ul className="text-black dark:text-black space-y-2 mb-6">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Tankless Water Heaters</h2>
              <p className="text-black dark:text-black mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Benefits of Tankless Water Heaters</h3>
              <ul className="text-black dark:text-black space-y-2 mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Tankless Installation Considerations</h3>
              <ul className="text-black dark:text-black space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-6">Common Questions About Water Heaters</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-black dark:text-black mb-2">How much does water heater installation cost?</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black dark:text-black mb-2">How long does water heater installation take?</h3>
                  <p className="text-black dark:text-black">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black dark:text-black mb-2">Should I repair or replace my water heater?</h3>
                  <p className="text-black dark:text-black">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black dark:text-black mb-2">How often should I maintain my water heater?</h3>
                  <p className="text-black dark:text-black">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-black dark:text-black mb-2">Do you provide emergency water heater service?</h3>
                  <p className="text-black dark:text-black">
