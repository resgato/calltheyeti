...
export default function RepairsPage() {
  const serviceJsonLd = buildServicePageJsonLd({
    ...
    description: "Emergency plumbing repair services in Phoenix, Arizona. Leak fixes, drain cleaning, pipe repairs, and same-day service.",
    url: "https://calltheyeti.com/services/repairs",
    image: "https://calltheyeti.com/sinksfixed.jpeg",
  });
  const breadcrumbJsonLd = buildBreadcrumbJsonLd([
    { name: "Home", url: "https://calltheyeti.com" },
    { name: "Services", url: "https://calltheyeti.com/services" },
    { name: "Repairs", url: "https://calltheyeti.com/services/repairs" },
  ]);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Emergency Plumbing Repairs</h2>
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Emergency Repair Services</h3>
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Leak Detection & Repair</h2>
              <p className="text-black dark:text-black mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Types of Leaks We Repair</h3>
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Leak Detection Methods</h3>
              <ul className="text-black dark:text-black space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Drain & Sewer Services</h2>
              <p className="text-black dark:text-black mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Drain Cleaning Services</h3>
              <ul className="text-black dark:text-black space-y-2 mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Drain Cleaning Methods</h3>
              <ul className="text-black dark:text-black space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Pipe Repair & Replacement</h2>
              <p className="text-black dark:text-black mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Pipe Repair Services</h3>
              <ul className="text-black dark:text-black space-y-2 mb-6">
              ...
              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Pipe Replacement Methods</h3>
              <ul className="text-black dark:text-black space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Fixture Repair & Replacement</h2>
              <p className="text-black dark:text-black mb-6">
                We repair and replace all types of plumbing fixtures to ensure proper function and 
                water efficiency.
              </p>

              <h3 className="text-xl font-semibold text-black dark:text-black mb-3">Fixture Services</h3>
              <ul className="text-black dark:text-black space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-4">Preventive Maintenance</h2>
              <p className="text-black dark:text-black mb-6">
            ...
            <section>
              <h2 className="text-2xl font-bold text-black dark:text-black mb-6">Common Questions About Plumbing Repairs</h2>
              
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-black dark:text-black mb-2">How much do plumbing repairs cost?</h3>
