...
export default function BathtubsShowersPage() {
  const serviceJsonLd = buildServicePageJsonLd({
    name: "Bathtub & Shower Installation",
    description: "Bathtub and shower installation, repair, and replacement in Phoenix, Arizona. New installations, upgrades, and accessibility modifications.",
    url: "https://calltheyeti.com/services/bathtubs-showers",
  ...
  const breadcrumbJsonLd = buildBreadcrumbJsonLd([
    ...
    { name: "Bathtubs & Showers", url: "https://calltheyeti.com/services/bathtubs-showers" },
  ]);
    ...
    <main className="mx-auto max-w-6xl px-4 py-10 md:py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          <div className="mb-8">
            <img src="/bathtub.jpg" alt="Bathtub and shower installation" className="w-full h-64 object-cover rounded-2xl shadow-md" />
          </div>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <div className="my-8">
                <img src="/bathtubbefore.jpg" alt="Bathtub before installation" className="w-full h-48 object-cover rounded-2xl shadow-md" />
              </div>
            ...
            <section>
              ...
              <div className="my-8">
                <img src="/shower.jpeg" alt="Shower installation work" className="w-full h-48 object-cover rounded-2xl shadow-md" />
              </div>
